...
public class ListProductAdapter extends RecyclerView.Adapter<ListProductAdapter.ProductViewHolder> {
    ...
    public ListProductAdapter(Context context, ArrayList<Product> listProduct, String name, int id) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ListProductAdapter.ProductViewHolder holder, int product) {
        ...
        holder.category.setText( this.name);
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("ID", listProduct.get(getAdapterPosition()).getId());
                    if(id > 0){
